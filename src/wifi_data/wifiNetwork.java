...
public class wifiNetwork {
	...
	public int RSSI, Channel,NumberOWN;
	public String  SSID, MAC, FirstSeen, Id;
	
	
	public List<Integer> RSSI2= new ArrayList<>();
	public List<Integer> Channel3= new ArrayList<>();
	public List<String> SSID2= new ArrayList<>();
	public List<String> MAC2= new ArrayList<>();
